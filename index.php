...
<section class="section">
			...
			<div class="col-lg-8  mb-5 mb-lg-0">
				...
				<article class="row mb-5">
					...
					<div class="col-12 mx-auto">
						<h3><a class="post-title" href="#">Cheerful Loving Couple Bakers Drinking Coffee</a></h3>
						<ul class="list-inline post-meta mb-4">
							<li class="list-inline-item"><i class="ti-user mr-2"></i><a href="#">John Doe</a>
							</li>
							<li class="list-inline-item">Date : March 14, 2020</li>
   ...
   <div class="widget">
      ...
      <ul class="list-unstyled widget-list">
         <li><a href="#!" class="d-flex">Identity Governance
               <small class="ml-auto">(1)</small></a>
         </li>
         <li><a href="#!" class="d-flex">Microsoft Defenders
               <small class="ml-auto">(2)</small></a>
         </li>
         <li><a href="#!" class="d-flex">Storage
               <small class="ml-auto">(1)</small></a>
         </li>
         <li><a href="#!" class="d-flex">Compute
               <small class="ml-auto">(2)</small></a>
         </li>
         <li><a href="#!" class="d-flex">Sync Services
               <small class="ml-auto">(1)</small></a>
         </li>
      </ul>
   </div>
   ...
   <div class="widget">
      ...
      <ul class="list-unstyled widget-list">
         <li class="media widget-post align-items-center">
            ...
            <div class="media-body">
               <h5 class="h6 mb-0"><a href="#">Protect against AzureAD OAuth Consent phishing attempts (Illicit consent attack)</a></h5>
      ...
      <ul class="list-unstyled widget-list">
         <li class="media widget-post align-items-center">
            ...
            <div class="media-body">
               <h5 class="h6 mb-0"><a href="#">How to mitigate MFA fatigue and learn from the Uber breach for additional protection</a>
               </h5>
      ...
      <ul class="list-unstyled widget-list">
         <li class="media widget-post align-items-center">
            ...
            <div class="media-body">
               <h5 class="h6 mb-0"><a href="#">Stream Azure AD Identity Protection events to Microsoft Sentinel/ Log Analytics</a>
               </h5>
               <small>March 14, 2020</small>
            </div>
         </li>
