		...
		<div class="row">
			<div class="col-12">
				<div class="title-bordered mb-5 d-flex align-items-center">
					<h1 class="h4">Talk To Us Anytime :)</h1>
			...
			<div class="col-md-6">
				<div class="content mb-5">
					...
					<p>We value your message and would love to hear from you. If you have any questions, suggestions, or concerns, please don't hesitate to reach out to us.</p>
					<h4 class="mt-5">Hate Forms? Write Us Email</h4>
					<p><i class="ti-email mr-2 text-primary"></i><a href="mailto:georgia.young@example.com">welcome@waheedanjum.eu</a>
					</p>
				</div>
			</div>
			<div class="col-md-6">
